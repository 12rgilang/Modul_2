...
let DetailProduct = () => {
    ...
    return(
        ...
        {/* select size */}
        <div className="parent-size flex mt-10 ml-5">
            {/* left */}
        ...
        <div className="cart flex m-4 fixed bottom-2 border-black text-white font-bold rounded-full px-3 py-3 my-bg-main  text-lg">
